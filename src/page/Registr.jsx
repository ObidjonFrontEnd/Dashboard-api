...
function Registr() {
	...
	const [fullname, setLogin] = useState('')
	const navigate = useNavigate()
	const { postData, loading, error, setError } = usePostApi('/auth/register')
	...
	return (
		<div className='h-full flex flex-col gap-[53px] justify-center px-[20px]'>
			<div className='title text-center px-[20px] text-[#4F4F4F] text-[36px] font-kumbh font-semibold'>
			...
			<div
				...
				} duration-[1s] flex  absolute top-[25px] right-[25px] bg-red-500 rounded-[4px] justify-center items-center p-[10px] w-[300px] md:w-[400px] h-[80px]`}
			>
			...
			>
				...
				<label htmlFor=''>
					<input
						type='text'
						className='w-full h-[42px] text-[#8A8A8A] text-[14px] font-kumbh px-[13px]  outline-none border-[#A7A7A7] border-[1px] border-solid rounded-[4px]'
